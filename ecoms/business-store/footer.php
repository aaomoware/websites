...
<footer id="colophon" role="contentinfo" class="site-footer  <?php echo esc_attr( $business_store_class );?>" style="background:<?php echo esc_attr( $business_store_option['footer_section_background_color'] ); ?>;">
