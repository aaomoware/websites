...
$wp_customize->add_section( 'business_store_lite' , array(
		...
		$wp_customize->add_control( new business_store_more_Control( $wp_customize, 'business_store_lite', array(
			'label'    => __( 'Business Store Premium', 'business-store' ),
...
//template settings
require business_store_TEMPLATE_DIR.'/inc/customizer/pages.php';
...
// featured areas
require business_store_TEMPLATE_DIR.'/inc/customizer/hero.php';
...
require business_store_TEMPLATE_DIR.'/inc/customizer/featured-product.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/onsale-product.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/home-shop.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/bestselling-product.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/toprated-product.php';

require business_store_TEMPLATE_DIR.'/inc/customizer/service.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/contact.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/team.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/news.php';
require business_store_TEMPLATE_DIR.'/inc/customizer/testimonials.php';
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'business_store_more_Control' ) ) :
class business_store_more_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label style="overflow: hidden; zoom: 1;">
			...
			<div class="col-md-4 col-sm-6" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);padding:3px; background-color:#FFF">
				<img  src="<?php echo esc_url(business_store_TEMPLATE_DIR_URI .'/screenshot.png'); ?>">
			</div>			
			<div class="col-md-3 col-sm-6" style="font-weight:500;">
				...
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i><b> <?php esc_html_e('* With Business store Pro theme, access to all premium themes free','business-store'); ?></b></div></td>
				</tr>						
				<tr>
				<td>
				...
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('* 15+ Featured sections for great reusability and build your store in no time.','business-store'); ?></div></td>
				</tr>			
							
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i><?php esc_html_e('*  Unlimited services','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  Unlimited News/Events','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				...
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  Unlimited Team members','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  More Call to action options and customization','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				...
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  One page home template and 15+ Featured sections','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  All templates customizable','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i><?php esc_html_e('*  Team Template','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('*  Contact Template','business-store'); ?></div></td>
				</tr>
				...
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i><?php esc_html_e('*  One page home template','business-store'); ?></div></td>
				</tr>
				<tr>
				<td>
