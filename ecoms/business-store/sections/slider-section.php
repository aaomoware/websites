...
<section id="slider-section">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3">
			<?php business_store_product_navigation(esc_html__('Product Categories','business-store')); ?>
			</div>
...
<img class="carousel-no-image" src="<?php echo esc_url(business_store_TEMPLATE_DIR_URI.'/images/header.png'); ?>" alt="<?php esc_attr_e('No Image','business-store'); ?>" style="height:350px;">
			<div class="carousel-caption custom-caption" style="top:12%">
				<h1 class="slider-title"><?php esc_html_e('Create a page from home-page template and start customizing','business-store'); ?></h1>
			</div>
</div>
<?php } ?>			
<?php else: ?>
